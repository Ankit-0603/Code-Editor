                                        ...
                                        >
                                            ...
                                            <div className="prose prose-invert prose-sm max-w-none">
                                                <ReactMarkdown
                                                    ...
                                                    components={{
                                                        // Block code: react-markdown wraps fenced code in <pre>,
                                                        // so we style the wrapper here instead of inside `code`.
                                                        pre: ({ children }) => (
                                                        ...
                                                        // `inline` was removed in react-markdown v9.
                                                        // Fenced blocks get a "language-xxx" class or contain
                                                        // newlines; inline `code` has neither.
