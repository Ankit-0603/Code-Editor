...
//   Panel             -> Panel      (numeric sizes are now PIXELS; use "50%" for percent)
...
function ResizableHandle({
  ...
  // In a horizontal group the separator is a vertical bar (aria-orientation="vertical"),
  // and in a vertical group it is a horizontal bar (aria-orientation="horizontal").
  return (
